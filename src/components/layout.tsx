    ...
    return (
        <div className='min-h-screen bg-zinc-900 antialiased selection:bg-teal-600/90 selection:text-white'>
            ...
            <div className='layout-sm relative z-10 grid gap-y-8 px-4 pt-12 text-emerald-200/90 xl:layout-xl xl:gap-x-9 xl:px-0 [&>*]:col-start-2 xl:[&>*]:col-start-3'>
                ...
                <main
                    className={cn('container relative z-30 flex flex-col text-base text-zinc-100/90 md:w-[45rem]', {
                        'pt-24': !showNav,
                        'pt-48': showNav
                    })}
                >
                                ...
                                <div>
                                    ...
                                    <div className='items-center space-y-2 sm:flex sm:space-x-2 sm:space-y-0'>
                                        ...
                                        <div className='flex space-x-2'>
                                            ...
                                            >
                                                <div className='sm:mb-1 size-6 rounded-md bg-black text-white shadow-lg shadow-teal-900/60 ring-2 ring-teal-400/20 group-hover:shadow-xl group-hover:shadow-teal-700 group-hover:ring-teal-400/30'>
